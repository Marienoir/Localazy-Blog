...
export default function SocialSignInButton({ provider }: { provider: Provider }) {
  const { t } = useTranslation('auth');
  const redirectTo = useAuthRedirectUrl('/auth/callback');
  ...
  const signIn = useCallback(() => supabaseClient.auth.signIn({ provider }, { redirectTo }), [provider, redirectTo]);
